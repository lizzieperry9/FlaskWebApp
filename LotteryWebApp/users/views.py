...
def register():
    ...
    if form.validate_on_submit():
        ...
        # add successful user registration to log
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user or not check_password_hash(user.password, form.password.data):
            ...
            # add invalid login attempt to log
            logging.warning('SECURITY - Invalid Login Attempt in [%s, %s, %s]', current_user.id, current_user.email,
                            request.remote_addr)
